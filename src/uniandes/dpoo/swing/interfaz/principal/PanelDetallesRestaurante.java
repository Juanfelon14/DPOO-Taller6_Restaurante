...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    /**
     * Actualiza los datos mostrados del restaurante, indica los valores por separado
     * @param nombre
     * @param calificacion
     * @param visitado
     */

    public void actualizarRestaurante(String nombre, int calificacion, boolean visitado)
    {
        labNombre.setText("Nombre: " + nombre);
        if(calificacion >= 1 && calificacion <= 5){
            labCalificacion.setText("Calificación: ");
    ...
    /**
     * Dada una calificación, retorna una imagen para utilizar en
     * la etiqueta que muestra la calificación
